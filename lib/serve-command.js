...
function execute(params) {
    ...
    app.get('/api/rest/feature/tree', function (req, res) {
        res.send(walker.walkSync(sourceDir, visibleDirectoriesAndGherkinSourceFiles));

        function visibleDirectoriesAndGherkinSourceFiles(filePath, stats) {
    ...
    app.get('/api/rest/feature/parsed/:path', function (req, res) {
        var feature = gherkin.parse(path.join(sourceDir, req.params.path), summary.language);
