    ...
    var featureAsJson = {
        ...
        lexer = new Lexer({
            ...
            tag: function onTag(value, line) {
                if (lastKeywordWithTags === 'feature') {
                    featureAsJson.tags.push(value);
                }
                if (lastKeywordWithTags === 'scenario') {
                    lastScenario().tags.push(value);
                }
            },
            feature: function onFeature(keyword, name, description, line) {
                lastKeywordWithTags = 'feature';
            ...
            scenario_outline: function onScenarioOutline(keyword, name, description, line) {
                ...
                lastKeywordWithTags = 'scenario_outline';
